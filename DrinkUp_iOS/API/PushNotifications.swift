...
class PushNotification: NSObject, UNUserNotificationCenterDelegate, MessagingDelegate {
    ...
    static func send(title: String?, message: String?, toDeviceWithToken token: String) {
        ...
        request.setValue("key=AAAAfVkQ4y0:APA91bEzBB7JmR4vzadJQyzfx-zDmuDVMtnd66OKyJLHzU6JvjPZMK9XZUs99miQF5w6LdyZrMXfuKUc4t_8MZ7yZpz1w8PzHOMYA8w-dFyFEamHUir3-t2cKf8h5HuE4e2tK9sDKNNg", forHTTPHeaderField: "Authorization")
